                    ...
                    <?php
                        while($row=mysqli_fetch_array($q)){ ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="MemberInfoEdit.php?mid=<?php echo $row['ID']?>">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="MemberInfoDelete.php?mid=<?php echo $row['ID']?>">Delete</a>
                                </td>
                            </tr>
                        <?php }
                    ?>
