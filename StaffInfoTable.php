    ...
    <h1>GYM Management System</h1>
            <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mt-3">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">Staff Information</a>
                    ...
                    <?php
                        while($row=mysqli_fetch_array($q)){ ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info" href="StaffInfoEdit.php?sid=<?php echo $row['ID']?>">Edit</a>
                                    <a class="btn btn-sm btn-danger" href="StaffInfoDelete.php?sid=<?php echo $row['ID']?>">Delete</a>
                                </td>
                            </tr>
                        <?php }
                    ?>
