...
<?php
    $str="SELECT Username from staff";
    $q=mysqli_query($conn, $str);
?>
<?php
    $sid = $_REQUEST['sid'];
    $s = "SELECT * FROM staff WHERE ID=$sid";
...
<?php
    if(ISSET($_POST['submit'])){
        ...
        $str="UPDATE staff SET Username='$name',Email='$email' WHERE ID='$sid'";
    ...
    <h1>GYM Management System</h1>
            <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mt-3">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">Staff Information Edit</a>
