...
<?php
    $str="SELECT Username from member";
    $q=mysqli_query($conn, $str);
?>
<?php
    $mid = $_REQUEST['mid'];
    $s = "SELECT * FROM member WHERE ID=$mid";
...
<?php
    if(ISSET($_POST['submit'])){
        ...
        $str="UPDATE member SET Username='$name',Email='$email' WHERE ID='$mid'";
    ...
    <h1>GYM Management System</h1>
            <nav class="navbar navbar-expand-lg navbar-dark bg-secondary mt-3">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">Member Information Edit</a>
